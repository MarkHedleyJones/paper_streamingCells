...
\begin{document}
    ...
    Approximately 100 times the required power to operate an automatic meter reader and transmitter is already dissipated inside today's mechanical water meters.
    ...
    It is our conclusion that energy harvesting for the purpose of automatic meter reading using streaming cells is not a practical option.
    Other methods of energy harvesting from water flow should produce favourable results based on the abundance of available energy.
